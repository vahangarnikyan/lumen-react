...
<head>
  ...
  <title>Ganagratis email confirmation</title>
</head>
  ...
  <div style="background-color:#000000; color: #ffffff; margin: 0; padding: 0;">
    <div style="min-width: 280px; max-width: 640px; margin-left: auto; margin-right: auto; padding: 0 20px;">
      <div style="padding: 20px 0; margin: 0;">
        <a href="<?php echo url('/'); ?>" style="font-size: 28px; text-decoration: none; color: #ffffff">Ganagratis</a>
      </div>
      <div style="background-color: #ffffff; color: #000000; margin: 0; padding:1px 20px;">
        ...
        <p style="display: block; color: #000000">
          Thanks for registering. Please press confirm email to activate your Ganagratis.com account.
        </p>
      ...
      <div style="padding: 20px 0; margin: 0;">
        <span style="color: #ffffff;">&copy;2020 All rights reserved</span>
      </div>
    </div>
  </div>
</body>
